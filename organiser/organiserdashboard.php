    ...
    <div class="main_container">
          ...
          <div class="nav_result">
                <div class="organiser_dashboard_container">
                    ...
                    <div class="stats">
                    <div class="all_hackathon_count count_div">
                        <h1>50</h1>
                        <p>Total Hackathons</p>
                    </div>
                    <div class="active_hackathon_count count_div">
                        <h1>2</h1>
                        <p>Active Hackathon</p>
                    </div>
                    <div class="teams_participating_count count_div">
                        <h1>4</h1>
                        <p>Teams Participating</p>
                    </div>
                    <div class="project_submitted_count count_div">
                        <h1>10</h1>
                ...
                <br>
                <br>
                    <h4>All active hackathon</h4>
                    <div class="active_hackathon_table">
                        ...
                        <tbody>
                            ...
                            <?php
                            include '../connect.php';
                            $sql = "SELECT hackathonId, hackathonName, hackathonLocation, organiserId, startDate, endDate, status FROM hackathon where status = 'Active'";  // Prepared Statement
